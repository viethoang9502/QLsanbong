...
import vhoang.qlsanbong.myapp.ui.adapter.AdapterListView_NV;
...
//                        if (validate()){}
                        ...
                        if(tkAdd.getText().toString().trim().equals("")&&mkAdd.getText().toString().trim().equals("")&&
                            ...
                            ApplicationDatabase.getInstance(DSNhanVien.this).dao_nv().insertNV(nv);
                            loadData();
                            dialog.dismiss();
                        }
...
//                        }
    ...
    public void loadData() {
        list = (ArrayList<TaiKhoan>) ApplicationDatabase.getInstance(DSNhanVien.this).dao_nv().getAllNV();
    ...
    public int sonv(){
        int x = 0;
        lissonv =(ArrayList<TaiKhoan>) ApplicationDatabase.getInstance(DSNhanVien.this).dao_nv().getAllNV();
